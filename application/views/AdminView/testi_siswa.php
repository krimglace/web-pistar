...
<div class="content-wrapper">
	<div class="container-fluid">
		...
		<div class="content-content bg-white pt-4 pr-3 pl-3 pb-3">
			...
			<div class="section-3">
				<h4 class="mb-4"><strong>Data Testimoni Siswa</strong></h4>
				<table class="table table-bordered table-stripped text-center">
					...
					<?php $no = 1; foreach( $testimoni_siswa as $testi ) :  ?>
						<tr>
							<td><?= $no++ ?></td>
							<td><?= $testi->isi_testimoni ?></td>
							<td><a href="<?= base_url('Administrator/Testimoni/HapusSiswa/'.$testi->id_testimoni) ?>"><h3><i class="text-danger fa fa-trash"></i></h3></a></td>
						</tr>
					<?php endforeach; ?>
