				...
				<?php foreach( $admin as $adm ) : ?>
					<div class="left-about">
						<div class="tentang-logo text-center">
							<form enctype="multipart/form-data" method="post" action="<?= base_url('Administrator/Profil/Ganti_FotoProfil') ?>">
								<div class="form-group">
									<input type="hidden" name="id" class="form-control text-center" value="<?= $adm->id ?>">
								</div>
								<h4><strong>Foto Profil</strong></h4>
								<img src="<?= base_url('assets/mystyle/img/admin/'.$adm->pp_admin) ?>" width="75%"><br><br>
								<h6><strong>Ganti Foto</strong></h6>
								<input type="file" name="pp_admin" class="form-control"><br>
					...
					<div class="right-about pl-3">
						<div class="tentang-tentang">
							<form method="post" action="<?= base_url('Administrator/Profil/Ganti_Profil') ?>">
								<div class="form-group">
									<label>ID Admin</label>
									<input type="text" name="id" class="form-control" value="<?= $adm->id ?>" readonly>
								</div>
								<div class="form-group">
									<label>Nama Lengkap Admin</label>
									<input type="text" name="nama_lengkap_admin" class="form-control" value="<?= $adm->nama_lengkap_admin ?>">
								</div>
								<div class="form-group">
									<label>Nama Panggilan Admin</label>
									<input type="text" name="nama_panggilan_admin" class="form-control" value="<?= $adm->nama_panggilan_admin ?>">
								</div>
								<div class="form-group">
									<label>Email Admin</label>
									<input type="email" name="email_admin" class="form-control" value="<?= $adm->email_admin ?>">
								</div>
								<div class="form-group">
									<div class="float-left col-7">
										<label>Password Admin</label>
										<input readonly type="password" name="password" class="form-control" value="<?= $adm->password_admin ?>">
									</div>
...
<div class="modal fade" style="z-index: 100000" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url('Administrator/Profil/Ganti_Password') ?>">
