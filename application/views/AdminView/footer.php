		<footer class="main-footer">
	    	<strong>Copyright &copy; 2022 <a href="<?= base_url('Home') ?>">PISTAR</a>.</strong> All rights reserved.
	  	</footer>
	</div>
<!-- ./wrapper -->
...
<!-- Sparkline -->
<script src="<?= base_url() ?>assets/vendor/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="<?= base_url() ?>assets/vendor/jqvmap/jquery.vmap.min.js"></script>
<script src="<?= base_url() ?>assets/vendor/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?= base_url() ?>assets/vendor/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
