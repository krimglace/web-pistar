	...
	<div class="main-content">
		...
		<form action="<?= base_url('Cari_Pengajar/Filter') ?>" method="post">
			<div class="form-group mapel">
				<input id="mata_pelajaran" type="text" name="mata_pelajaran" placeholder="Ketik Mata Pelajaran" class="form-control">
			</div>
			<div class="form-group mapel">
				<input id="kabupaten" type="text" name="kabupaten" placeholder="Ketik Lokasi (Kabupaten/Kota)" class="form-control">
			</div>
