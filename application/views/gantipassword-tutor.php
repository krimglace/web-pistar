	...
	<div class="body">
		...
		<div class="form">
			...
			<div class="form-title text-center">
				...
				<div style="position: relative; justify-content: center; align-items: center; display: flex; border-radius: 20px; background-color: white;">
					<img src="<?= base_url('assets/mystyle/img/tutor/'.$adm->gambar_guru) ?>" style="float: left; width: 50px; height: 50px; border-radius: 50%;">
					<h4 style="float: left; width: 60%"><?= $adm->nama_lengkap_tutor ?></h4>
		...
		<div class="gantipassword nonaktif animate__animated">
			<div class="container bg-white p-3" style="border-radius: 20px;">
				...
				<div class="clearfix"></div>
				<br>
				<form style="text-align: justify;" action="<?= base_url('Login/proses_gantipassword_tutor') ?>" method="post">
					<input type="hidden" name="id_tutor" value="<?= $adm->id_tutor ?>">
