	...
	<div class="body">
		...
		<div class="form">
			...
			<div class="form-title text-center">
				...
				<div style="position: relative; justify-content: center; align-items: center; display: flex; border-radius: 20px; background-color: white;">
					<img src="<?= base_url('assets/mystyle/img/admin/'.$adm->pp_admin) ?>" style="float: left; width: 50px; height: 50px; border-radius: 50%;">
					<h4 style="float: left; width: 60%"><?= $adm->nama_lengkap_admin ?></h4>
					<div class="clearfix"></div>
				</div>
				<div>
					<br>
					<button onclick="gantipassword()" class="btn btn-primary">Ya, ini akun saya</button>
					<a href="<?= base_url('Administrators') ?>" class="btn btn-danger">Tidak, ini bukan akun saya</a>
				</div>
			</div>
		</div>
		<div class="gantipassword nonaktif animate__animated">
			<div class="container bg-white p-3" style="border-radius: 20px;">
				...
				<div class="clearfix"></div>
				<br>
				<form style="text-align: justify;" action="<?= base_url('Administrators/proses_gantipassword') ?>" method="post">
